...
AIDA()
{
    ...
    select several
    {
        ...
        mod[11] = AIDA_MODULE(module_id = 11, PARAMS); // 12 FEEs used for S452?
...
AIDA_ADC(module_id, PARAMS_DEF)
{
    ...
    UINT32 wordA NOENCODE
    {   
        // this all matches void ADCDataItem:: in AIDA_Data_Types.cxx
        0_15: adc_value; // adc data // energy?
        16_21: channel_id = RANGE(0, 63); // channel number
        22_27: module_id = MATCH(module_id); // FEE number
        28: adc_range;
        29: 0;
        30_31: 0x3;
    }
