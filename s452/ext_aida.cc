...
EXT_DECL_DATA_SRC_FCN(void, EXT_AIDA::__unpack)
{
  ...
  std::cout << std::hex << "wrID: " << wrID << std::endl;
  std::cout << "wr1: " << wr1 << std::endl;
  std::cout << "wr2: " << wr2 << std::endl;
  std::cout << "wr3: " << wr3 << std::endl;
  std::cout << "wr4: " << wr4 << std::dec << std::endl;
  ...
  std::cout << "White Rabbit Time: " << cur_timestamp << std::endl;
