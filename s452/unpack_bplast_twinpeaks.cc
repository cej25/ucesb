...
#include "unpack_bplast_twinpeaks.hh"
...
void EXT_PLASTIC_TP::__clean()
{
    //something clean
    plastic_tp_info.__clean();
}

EXT_DECL_DATA_SRC_FCN(void, EXT_PLASTIC_TP::__unpack)
{   
...
EXT_FORCE_IMPL_DATA_SRC_FCN(void, EXT_PLASTIC_TP::__unpack);

template<typename __data_src_t>
void EXT_PLASTIC_TP::Process_TAMEX(__data_src_t &__buffer, plastic_twinpeaks_item &item)
{
...
template<typename __data_src_t>
void EXT_PLASTIC_TP::get_trigger(__data_src_t &__buffer, plastic_twinpeaks_item &item)
{
...
template<typename __data_src_t>
void EXT_PLASTIC_TP::get_edges(__data_src_t &__buffer, plastic_twinpeaks_item &item)
{
    item.iterator[item.tamex_iter] = 0;
...
template<typename __data_src_t>
bool EXT_PLASTIC_TP::no_error_reached(__data_src_t &__buffer, plastic_twinpeaks_item &item)
{
...
template<typename __data_src_t>
void EXT_PLASTIC_TP::check_trailer(__data_src_t &__buffer, plastic_twinpeaks_item &item)
{
    __buffer.advance(4);
...
const char* plastic_twinpeaks_item::get_name(const std::string &name, int index) const
{
...
const char* plastic_twinpeaks_item::get_name2(const std::string &name, int index, int index2) const
{
    std::ostringstream oss;
