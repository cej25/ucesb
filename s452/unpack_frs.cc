...
void EXT_FRS::FRS_Sort(frs_item &item, int procid, int type, int subtype)
{
    ...
    // trigger and TPAT
    item.trigger = item.qtrigger;
    item.pattern = item.utpat;
    ...
    item.de_42r = item.vme_main[4][1] & 0xFFF;
...
void frs_item::dump(const signal_id &id, pretty_dump_info &pdi) const
{
    ...
    *@param xs2     Position at S2
    *@param xc      Position at Cave
    *@param tof     Time of Flight or something
    */


    ::dump_float(id_z, signal_id(id, "id_z"), pdi);
    ::dump_float(id_AoQ_corr, signal_id(id, "id_AoQ_corr"), pdi);
    ::dump_float(id_a2, signal_id(id, "id_a2"), pdi);
    ::dump_float(id_a4, signal_id(id, "id_a4"), pdi);
    ::dump_float(id_x2, signal_id(id, "id_x2"), pdi);
    ::dump_float(id_x4, signal_id(id, "id_x4"), pdi);
    ::dump_float(id_beta, signal_id(id, "id_beta"), pdi);
    ::dump_float(id_brho[0], signal_id(id, "brho0"), pdi);
    ::dump_float(id_brho[1], signal_id(id, "brho1"), pdi);
}
...
{   
    ::zero_suppress_info_ptrs(&id_z, used_info);
    ::zero_suppress_info_ptrs(&id_AoQ_corr, used_info);
    ::zero_suppress_info_ptrs(&id_a2, used_info);
    ::zero_suppress_info_ptrs(&id_a4, used_info);
    ::zero_suppress_info_ptrs(&id_x2, used_info);
    ::zero_suppress_info_ptrs(&id_x4, used_info);
    ::zero_suppress_info_ptrs(&id_beta, used_info);
    ::zero_suppress_info_ptrs(&id_brho[0], used_info);
    ::zero_suppress_info_ptrs(&id_brho[1], used_info);
...
{   
    ...
    callback(signal_id(id, "id_z"), enumerate_info(info, &id_z, ENUM_TYPE_FLOAT), extra);
    callback(signal_id(id, "id_AoQ_corr"), enumerate_info(info, &id_AoQ_corr, ENUM_TYPE_FLOAT), extra);
    callback(signal_id(id, "id_a2"), enumerate_info(info, &id_a2, ENUM_TYPE_FLOAT), extra);
    callback(signal_id(id, "id_a4"), enumerate_info(info, &id_a4, ENUM_TYPE_FLOAT), extra);
    callback(signal_id(id, "id_x2"), enumerate_info(info, &id_x2, ENUM_TYPE_FLOAT), extra);
    callback(signal_id(id, "id_x4"), enumerate_info(info, &id_x4, ENUM_TYPE_FLOAT), extra);
    callback(signal_id(id, "id_beta"), enumerate_info(info, &id_beta, ENUM_TYPE_FLOAT), extra);
    callback(signal_id(id, "id_brho0"), enumerate_info(info, &id_brho[0], ENUM_TYPE_FLOAT), extra);
    callback(signal_id(id, "id_brho1"), enumerate_info(info, &id_brho[1], ENUM_TYPE_FLOAT), extra);
