...
bool FEBEX_EVENT::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(143,uint32 ,sumchannel,sumchannel.u32,10);
  MATCH_BITS_EQUAL(136,sumchannel.unnamed_0_7,52);
  MATCH_BITS_EQUAL(140,sumchannel.unnamed_24_31,255);
  return true;
  return false;
}
...
bool FEBEX_PADDING::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(113,uint32 ,pads_data,pads_data.u32,12);
  MATCH_BITS_EQUAL(112,pads_data.unnamed_20_31,0xadd);
  return true;
  return false;
}
...
bool TIMESTAMP_WHITERABBIT::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(24,uint32 ,header,header.u32,18);
...
bool TIMESTAMP_WHITERABBIT_EXTENDED::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(61,uint32 ,header,header.u32,24);
...
bool WR_MULTI::__match(__data_src_t &__buffer)
{
  ...
  MATCH_READ_FROM_BUFFER_FULL(92,uint32 ,hi,hi.u32,27);
  return true;
  return false;
}
